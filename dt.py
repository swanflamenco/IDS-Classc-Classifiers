...
Original file is located at
    https://colab.research.google.com/drive/1OVQd4S06sW26BqkvG54WM40hE4BGuNBH
"""
...
rfe = RFE(DT_clf, n_features_to_select=10)
...
y_pred = DT_clf.predict(X_test_df)
