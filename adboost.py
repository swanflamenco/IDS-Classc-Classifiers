...
Original file is located at
    https://colab.research.google.com/drive/1hvDQyJRPEkoP37VJQm9SXcxYxl7BxNco
"""
...
ab_clf = AdaBoostClassifier(base_estimator=base_classifier)
ab_clf.fit(X_train_df, y_train)

rfe = RFE(ab_clf, n_features_to_select=10)
...
y_pred = ab_clf.predict(X_test_df)
